...
class Version20121226112627 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE acts_news_mentions ADD CONSTRAINT FK_9A671BDA81257D5D FOREIGN KEY (entity_id) REFERENCES acts_entities (id)");
        ...
        $this->addSql("ALTER TABLE acts_venues ADD address LONGTEXT DEFAULT NULL");
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE acts_venues DROP address");
