...
class Version20121209224636 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE  `acts_access` ENGINE = MYISAM, CONVERT TO CHARACTER SET latin1 COLLATE latin1_swedish_ci');
        ...
        $this->addSql('ALTER TABLE  `acts_email_sigs` ENGINE = MYISAM, CONVERT TO CHARACTER SET latin1 COLLATE latin1_swedish_ci');
