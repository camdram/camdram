...
class Version20131225203348 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE acts_api_apps (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, organisation_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, is_admin TINYINT(1) NOT NULL, website VARCHAR(1024) NOT NULL, INDEX IDX_297ABD2CA76ED395 (user_id), INDEX IDX_297ABD2C9E6B1585 (organisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
