...
const close_editor_nosave_e = make_evt_handler(close_editor, false);
const delete_row_e = make_evt_handler(delete_row);
const delete_role_e = make_evt_handler(set_role_deleted, true);
const undelete_role_e = make_evt_handler(set_role_deleted, false);
const open_editor_e = make_evt_handler(open_editor);
const add_row_e = make_evt_handler(add_row, false);
const add_row_bottom_e = make_evt_handler(add_row, true);
